...
3. **Get oriented.** Skim the README of the repo you'll work in and the open
   issues on its board. Use `dev-tools` to bring up the local dev / verify
